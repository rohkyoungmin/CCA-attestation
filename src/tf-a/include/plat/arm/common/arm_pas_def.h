...
#define ARM_TRBE_SIZE			U(0x2000000)
#define ARM_AGENT_SIZE			U(0x1C00000)
#define ARM_GPT_AG_SIZE			U(0x400000)
...
#define	ARM_PAS_TRUSTED_DRAM		GPT_MAP_REGION_GRANULE(PLAT_ARM_TRUSTED_DRAM_BASE, \
...
#define	ARM_PAS_OTHER_ANY			GPT_MAP_REGION_GRANULE(0x22000000, \
							       0xE000000, \
							       GPT_GPI_ANY)

#define	ARM_PAS_TRBE			GPT_MAP_REGION_GRANULE(ARM_PAS_2_BASE + ARM_PAS_2_SIZE - ARM_TRBE_SIZE - ARM_AGENT_SIZE - ARM_GPT_AG_SIZE, \
							       ARM_TRBE_SIZE, \
							       GPT_GPI_ROOT)

#define	ARM_PAS_AGENT			GPT_MAP_REGION_GRANULE(ARM_PAS_2_BASE + ARM_PAS_2_SIZE - ARM_AGENT_SIZE - ARM_GPT_AG_SIZE, \
							       ARM_AGENT_SIZE, \
							       GPT_GPI_SECURE)

#define	ARM_PAS_GPT_AG			GPT_MAP_REGION_GRANULE(ARM_PAS_2_BASE + ARM_PAS_2_SIZE - ARM_GPT_AG_SIZE, \
							       ARM_GPT_AG_SIZE, \
							       GPT_GPI_ROOT)
...
#define PAGE_TABLE_TRUSTED_DRAM 	MAP_REGION_FLAT(			\
						PLAT_ARM_TRUSTED_DRAM_BASE,			\
						PLAT_ARM_TRUSTED_DRAM_SIZE,\
						MT_MEMORY | MT_RW | MT_SECURE)

#define PAGE_TABLE_KERNEL_DRAM 	MAP_REGION_FLAT(			\
						ARM_PAS_2_BASE,			\
						ARM_PAS_2_SIZE,\
						MT_MEMORY | MT_RW | MT_NS)

#define PAGE_TABLE_KERNEL_1_DRAM 	MAP_REGION_FLAT(			\
						ARM_PAS_4_BASE,			\
						ARM_PAS_4_SIZE,\
						MT_MEMORY | MT_RW | MT_NS)
