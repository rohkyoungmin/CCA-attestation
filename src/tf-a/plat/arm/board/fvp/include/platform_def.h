...
#define PLAT_ARM_G0_IRQ_PROPS(grp)	ARM_G0_IRQ_PROPS(grp)
	/*
	INTR_PROP_DESC(FVP_PMI, GIC_HIGHEST_SEC_PRIORITY,             \
		(grp), GIC_INTR_CFG_LEVEL),    \
	INTR_PROP_DESC(FVP_PMI_2, GIC_HIGHEST_SEC_PRIORITY,             \
		(grp), GIC_INTR_CFG_LEVEL),    \
	INTR_PROP_DESC(FVP_PMI_3, GIC_HIGHEST_SEC_PRIORITY,             \
		(grp), GIC_INTR_CFG_LEVEL),    \
	INTR_PROP_DESC(FVP_PMI_4, GIC_HIGHEST_SEC_PRIORITY,             \
		(grp), GIC_INTR_CFG_LEVEL),    \
	*/
#if SDEI_IN_FCONF
