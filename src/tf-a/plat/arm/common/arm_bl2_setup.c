...
static void arm_bl2_plat_gpt_setup(void)
{
	 ...
	 */
	//The default gpt region of the tusted DRAM for Secure world is GPT_GPI_ANY by L0 GPT, we
	//can config this from 0x06000000 to 0x06000000+0x02000000 with L1 GPT to secure
