...
# Number of threads
# Any core can be used by OP-TEE. The number of cores that can be used concurrently is limited by the value of CFG_NUM_THREADS. You'll find code related to this in core/arch/arm/kernel/thread*
CFG_NUM_THREADS ?= 2
